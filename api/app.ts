...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || 'postgresql://tsdbadmin:fkg5r0atfl1dun5e@bfcl9opdwz.ikysjdfisk.tsdb.cloud.timescale.com:32129/tsdb',
...
router.get('/data', async (req, res) => {
  try {
    ...
    // ensure test_score_avg and attendance_rate are parsed as numbers 
    // since pg might return numeric as string
